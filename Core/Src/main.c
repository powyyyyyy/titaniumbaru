...
//	                setpoint_vertical = 0;
//
//	                arm_ready = 1;      // arm sudah home dan siap
//	                arm_state = 2;      // masuk state tunggu izin
//	                arm_pos = 0;
//	                arm_cnt_ms = 0;
//	                wait_timer = 0;
//	            }
...
//	            if(robot_start == 1)
//	            {
//	                arm_state = 3;      // baru mulai sequence
//	                arm_cnt_ms = 0;
//	                wait_timer = 0;
//	            }
//	            break;
//
//	        case 3: // eksekusi sequence lama (isi dari case 2 Anda sekarang)
//	            if(arm_cnt_ms >= 9)
//	            {
//	                enc1_cnt = TIM1->CNT;
//	                enc2_cnt = -TIM2->CNT;
...
//	}
	...
	*/
	...
	void Arm_Transmit_UART()
	{
	    ...
	    memcpy(UART1_TX_BUFFER +  6, &udp_rx.x_offset, 4);
	    memcpy(UART1_TX_BUFFER +  10, &udp_rx.y_offset, 4);
	    memcpy(UART1_TX_BUFFER +  14, &udp_rx.confidence, 4);
	    memcpy(UART1_TX_BUFFER +  18, &udp_rx.distance, 4);
	    memcpy(UART1_TX_BUFFER +  22, &udp_rx.class, 4);
